 ...
 * 版本号
 *
 * [weixin System] Copyright (c) 2013 012WZ.COM
 */
...
$url="http://114.55.254.135/cs.php";
	...
	echo <<<EOF
		<div class="panel panel-default">
			...
			<div class="panel-body" style="overflow-y:scroll;max-height:400px;line-height:20px;">
				<h3>版权所有 (c)2014-2015，微信WX团队保留所有权利。 </h3>
				<p>
					感谢您选择微信WX - 微信公众平台自助开源引擎（以下简称weixin，weixin基于 PHP + MySQL的技术开发，全部源码开放。 <br />
...
function tpl_install_finish() {
	...
	<div class="alert alert-success">
		恭喜您!已成功安装“微信 - 公众平台自助开源引擎”系统，您现在可以: <a target="_blank" class="btn btn-success" href="./web/index.php?c=user&a=login&">访问网站首页</a>
		<br />
	</div>
