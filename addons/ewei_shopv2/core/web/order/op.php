...
class Op_EweiShopV2Page extends WebPage 
{
	...
	public function changeprice() 
	{
		...
		if ($_W['ispost']) 
		{
			...
			m('notice')->sendOrderChangeMessage($item['openid'], array('title' => '订单金额', 'orderid' => $item['id'], 'ordersn' => $item['ordersn'], 'olddata' => $item['price'], 'data' => $orderprice, 'type' => 1), 'orderstatus');
			show_json(1);
		}
